    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-dark-bg relative overflow-hidden">
            ...
            <motion.div
                ...
                className="bg-white dark:bg-dark-card p-8 rounded-3xl shadow-2xl w-full max-w-md z-10 border border-white/20 backdrop-blur-sm"
            >
                ...
                {error && (
                    <div className={`p-3 rounded-xl mb-4 text-sm ${error.includes('successful') ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600'}`}>
                        {error}
                    </div>
                )}
